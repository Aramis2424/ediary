...
<div class="baseBacking">
    <div class="bg-white rounded-xl p-2 w-1/6 h-1/6 gap-4 shadow-xl relative flex flex-col justify-evenly content-center items-center entriesSearching">
        ...
        <button @click="applyFilters" class="baseBtn w-1/4">Применить</button>
